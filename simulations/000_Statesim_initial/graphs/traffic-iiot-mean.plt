...
plot \
 ...
 '../results/traffic-net=iiot.opts=100000.policy=PureFaaS.mean.dat' u 1:($2*1e-6) w l notitle lt 1 lc 1,\
 ...
 '../results/traffic-net=iiot.opts=100000.policy=StateLocal.mean.dat' u 1:($2*1e-6) w l notitle lt 1 lc 1,\
 ...
 '../results/traffic-net=iiot.opts=100000.policy=PureFaaS.mean.dat' u 1:($2*1e-6):($3*1e-6):($4*1e-6) w yerrorbars title "Medium/PureFaaS" lt 1 pt 6,\
 '../results/traffic-net=iiot.opts=1000000.policy=PureFaaS.mean.dat' u 1:($2*1e-6):($3*1e-6):($4*1e-6) w yerrorbars title "High/PureFaaS" lt 1 pt 8,\
 '../results/traffic-net=iiot.opts=10000.policy=StateLocal.mean.dat' u 1:($2*1e-6):($3*1e-6):($4*1e-6) w yerrorbars title "Light/StateLocal" lt 1 pt 5,\
 '../results/traffic-net=iiot.opts=100000.policy=StateLocal.mean.dat' u 1:($2*1e-6):($3*1e-6):($4*1e-6) w yerrorbars title "Medium/StateLocal" lt 1 pt 7,\
