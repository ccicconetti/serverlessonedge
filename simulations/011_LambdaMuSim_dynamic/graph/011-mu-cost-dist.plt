...
plot \
'< grep "2.000000,60000.000000,50,50,10,10,0.500000,0.500000,1" ../data/011-urban0.csv' u ($16/$14):(1) smooth cnorm title "E[|A|] = 50",\
'< grep "2.000000,60000.000000,50,100,10,10,0.500000,0.500000,1" ../data/011-urban0.csv' u ($16/$14):(1) smooth cnorm title "E[|A|] = 100",\
'< grep "2.000000,60000.000000,50,150,10,10,0.500000,0.500000,1" ../data/011-urban0.csv' u ($16/$14):(1) smooth cnorm title "E[|A|] = 150",\
'< grep "2.000000,60000.000000,50,200,10,10,0.500000,0.500000,1" ../data/011-urban0.csv' u ($16/$14):(1) smooth cnorm title "E[|A|] = 200",\
'< grep "2.000000,60000.000000,50,250,10,10,0.500000,0.500000,1" ../data/011-urban0.csv' u ($16/$14):(1) smooth cnorm title "E[|A|] = 250"
#    EOF
