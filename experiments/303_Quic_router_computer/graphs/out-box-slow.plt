...
GNUTERM = "wxt"
## Last datafile plotted: "../results/out.t=medium.l=0.e=grpc.1"
plot '../results/out.t=slow.l=0.e=grpc.1' u (1):($2*1e3),\
     '../results/out.t=slow.l=0.e=quic.1' u (2):($2*1e3),\
     '../results/out.t=slow.l=0.e=quic0rtt.1' u (3):($2*1e3)
#    EOF
