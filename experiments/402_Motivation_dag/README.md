...
Edge-cloud topology. The cloud is a single node. The client's app is made of a DAG of function invocations.
...
```
wget http://turig.iit.cnr.it/~claudio/public/soe-results-402.tgz
```
