...
function run {
  ...
  for e in $experiments ; do
    ...
    cmd="python $script_name --experiment $e --duration $duration --bw $b --delay $d --size $s --seed 1"
...
seed="1"
duration=60
bws="1 1000" # 0.1 1 10 100 1000
delays="100us 10000us" #100us 10ms 
sizes="1000" #100 1000 #no 10000 per bw=0.1
